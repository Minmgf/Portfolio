...
import '../slider.css'
import htmlIcon from '../icons/slider/html.svg'
import tailwindIcon from '../icons/slider/tailwind.svg'
import cssIcon from '../icons/slider/css.svg'
...
const Habilidades = () => {
  return (
    <section className=' flex-col w-2/3 px-2 py-2 mx-auto mt-12 bg-[#352E2E]  h-36 rounded-2xl'>
        <h2 className='w-full py-2 text-xl text-center text-white font-paytoneOne'>HABILIDADES</h2>
       

        <div className="my-4 slider opacity-60">
